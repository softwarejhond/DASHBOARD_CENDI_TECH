...
function generateCarnet($numberId, $username = null) {
    ...
    try {
        ...
        if ($isProduction) {
            ...
            $carnetDir = $_SERVER['DOCUMENT_ROOT'] . '/CENDITECH-DASHBOARD/carnets/';
        ...
        $headerCarnet = imgToBase64($rootPath . 'img/header_carnet_cendi.png');
        $footerCarnet = imgToBase64($rootPath . 'img/footer_carnet_cendi.png');
        
        // Generar URL del código QR
        $qrUrl = 'https://api.qrserver.com/v1/create-qr-code/?data=https://cenditech.com.co/studentInfo.php?id=' . urlencode($data['number_id']) . '&size=400x400';
            ...
            <div class="carnet-container">
                ...
                <div class="content">
                    ...
                    <div class="disclaimer">
                        Este carné acredita al portador como estudiante del programa CENDI Tech; es personal e intrasferible y se requiere su presentación para solicitar cualquier servicio y debe ser portado en un lugar visible durante su estadía en la entidad. En caso de pérdida o daño, se deberá informar de inmediato.
                    </div>
                </div>
