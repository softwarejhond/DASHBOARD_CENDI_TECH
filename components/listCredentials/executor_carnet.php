...
function generateExecutorCarnet($username, $generatedBy = null) {
    ...
    try {
        ...
        $qrUrl = 'https://api.qrserver.com/v1/create-qr-code/?data=https://cenditech.com.co/executorInfo.php?id=' . urlencode($data['username']) . '&size=400x400';
