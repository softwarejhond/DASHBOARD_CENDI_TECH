...
if ($isProduction) {
    ...
    $rootPath = $_SERVER['DOCUMENT_ROOT'] . '/CENDITECH-DASHBOARD/';
    $certFolder = $_SERVER['DOCUMENT_ROOT'] . '/CENDITECH-DASHBOARD/constancias/';
}
...
if ($constancia_existente) {
    ...
    try {
        ...
        $mail->setFrom('noreply@cenditech.com.co', 'CENDI Tech');
        $mail->CharSet = 'UTF-8';
        $mail->addAddress($email, $nombre_estudiante);
        $mail->isHTML(true);
        $mail->Subject = 'Constancia de Participación y Finalización Satisfactoria - Bootcamp CENDI Tech';
        ...
        <body>
            <div class='container'>
                <img src='https://cenditech.com.co/dashboard/img/header_correo_const.png' alt='Header Constancia' class='header-image'>
                <div class='content'>
                    <p>Hola <b>" . htmlspecialchars($nombre_estudiante) . "</b>,</p>
                    <p>Adjuntamos tu constancia de participación al bootcamp <b>" . htmlspecialchars($nombre_bootcamp) . "</b> del programa CENDI Tech.</p>
...
<body>
    ...
    <div class="justificado" style="margin-bottom:20px;">
        La <b>CENDI Tech</b>, en el marco del programa <b>CENDI Tech - Entrenamiento Intensivo en Innovación y Tecnología</b>, liderado por el <b>Ministerio de Tecnologías de la Información y las Comunicaciones - MinTIC</b>, se permite hacer constar que:
    </div>
    
    <div class="justificado" style="margin-bottom:25px;">
        <b>' . strtoupper($nombre_estudiante) . '</b>, identificado(a) con cédula de ciudadanía No. <b>' . $cedula . '</b>, ha atendido y cumplido con la intensidad horaria establecida para el BootCamp <b>' . $nombre_bootcamp . '</b> en modalidad <b>' . $modalidad_asistencia . '</b>, en concordancia con lo dispuesto en el programa CENDI Tech, dentro del <b>Contrato de Prestación de Servicios No. 1107-2025</b>, suscrito entre el MinTIC y la CENDI Tech.
    </div>
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <p>Es un honor para la <b>CENDI Tech</b> informarte que has culminado satisfactoriamente tu participación en el bootcamp <b>" . htmlspecialchars($nombre_bootcamp) . "</b> del programa <b>CENDI Tech - Entrenamiento Intensivo en Innovación y Tecnología</b>, liderado por el <b>Ministerio de Tecnologías de la Información y las Comunicaciones - MinTIC</b>.</p>
            ...
            <div class='footer'>
                <p>Equipo CENDI Tech</p>
                <p>En el marco del programa CENDI Tech del MINTIC</p>
            </div>
        </div>
    </body>
    </html>";
