...
if ($isProduction) {
    ...
    $certFolder = $_SERVER['DOCUMENT_ROOT'] . '/CENDITECH-DASHBOARD/certificados/';
}
...
if ($certificado_existente) {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Certificado de asistencia Bootcamp CENDI Tech';

        $mail->Body = "
            <p>Hola <b>" . htmlspecialchars($nombre_estudiante) . "</b>,</p>
            <p>Adjuntamos tu certificado de asistencia al bootcamp <b>" . htmlspecialchars($nombre_bootcamp) . "</b> del programa CENDI Tech.</p>
...
try {
    ...
    $mail->addAddress($email, $nombre_estudiante);
    $mail->isHTML(true);
    $mail->Subject = 'Certificado académico - Bootcamp CENDI Tech';

    // Reemplazar el cuerpo del correo por la imagen adjunta
    $mail->Body = '
        <div style="text-align:center;">
            <img src="https://cenditech.com.co/dashboard/img/cuerpo_certificado.png" alt="Certificado académico" style="max-width:100%;height:auto;">
        </div>
    ';
