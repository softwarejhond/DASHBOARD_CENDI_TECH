        ...
        <table id="tablaSedes" class="table table-striped">
            ...
            <tbody>
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "</td>";
                    echo "<td>
                            <button class='btn btn-sm bg-indigo-dark mx-2 text-white' onclick='editarSede(".$row['id'].", `".$row['name']."`, `".$row['mode']."`, `".$row['address']."`, ".(!empty($row['password']) ? 'true' : 'false').")'>
                ...
                <form id="formSede">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" role="switch" id="switchPassword" checked>
                            <label class="form-check-label" for="switchPassword">¿Requiere contraseña?</label>
                        </div>
...
document.getElementById('switchPassword').addEventListener('change', function() {
    ...
    if (this.checked) {
        ...
        passwordField.value = '';
        passwordField.placeholder = 'Sin contraseña';
    }
});
...
function editarSede(id, nombre, modalidad, address, hasPassword) {
    ...
    const switchEl = document.getElementById('switchPassword');
    const passwordField = document.getElementById('password');
    passwordField.value = '';
