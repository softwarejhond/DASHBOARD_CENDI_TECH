...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $query = "INSERT INTO headquarters (name, mode, address, password, created_by, date_creation, photo) VALUES (?, ?, ?, ?, ?, NOW(), ?)";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("ssssss", $nombre, $modalidad, $address, $hashedPassword, $created_by, $photoName);
