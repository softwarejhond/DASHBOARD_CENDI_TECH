            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.sedes && data.sedes.length > 0) {
                        const totalSedes = data.sedes.reduce((sum, sede) => sum + parseInt(sede.cantidad), 0);
                        $('#cantidadSedeLoteUno').text(totalSedes);
                    }

                    if (data.sedesMatriculados && data.sedesMatriculados.length > 0) {
                        const totalMatriculados = data.sedesMatriculados.reduce((sum, sede) => sum + parseInt(sede.cantidad), 0);
                        $('#cantidadSedeMatriculadosLoteUno').text(totalMatriculados);
                    }
