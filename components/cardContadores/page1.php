                ...
                <div class="d-flex mb-0">
                    <div class="">
                        <h4 class="card-title text-black">
                            <b>
                                <i class="fas fa-users fa-1x"></i> Registrados
        ...
        <div class="card  relative ">
            <div class="card-body z-10">
                <div class="d-flex align-items-center">
                    <h5 class="card-title text-black "><b><i class="bi bi-pie-chart-fill"></i> Matriculados</b>
                        <h><br>
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <h4 class="card-title text-black mb-0">
                            <b>
                                <i class="fa-solid fa-laptop-code"></i> Matriculados en Bootcamps
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card h-100">
                        <div class="card-body"><span class="corner corner-warning"></span>
                            <div class="d-flex mb-0">
                                <h3 class="card-title text-black "><b><i class="bi bi-person-slash"></i> Total de No Válidos</b>
                                    <h><br><br>
                                        ...
                                        <p class="mb-2 text-xs text-muted"><i class="bi bi-person-slash"></i> <span class="opacity-75">
                                                Usuarios No válidos según Interventoría</span></p>
                                        <div class="progress progress-sm h-5 mt-2 mb-3">
                                ...
                                <h3 class="card-title text-white "><b><i class="bi bi-telephone-inbound fa-1x "></i> Contacto a beneficiarios</b>
                                    <h><br>
                                        ...
                                        <p class="mb-2 text-xs text-white"><i class="bi bi-telephone-fill"></i><span class="opacity-75">
                                                Contacto establecido con beneficiarios</span></p>
                                        <div class="progress progress-sm h-5 mt-2 mb-3">
                        ...
                        <div class="d-flex mb-0 mt-3">
                            <div>
                                ...
                                <p class="mb-2 text-xs text-muted">
                                    ...
                                    <span class="opacity-75">Estudiantes inscritos por sede</span>
                                </p>
                                <div class="progress progress-sm h-5 mt-2 mb-3">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="d-flex mb-0 mt-3">
                            <div>
                                ...
                                <p class="mb-2 text-xs text-muted">
                                    <i class="fa fa-arrow-circle-up text-danger"></i>
                                    <span class="opacity-75">Estudiantes matriculados por sede</span>
                                </p>
                                <div class="progress progress-sm h-5 mt-2 mb-3">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        openModal.addEventListener('click', async () => {
            ...
            try {
                ...
                const sedes = datos.sedesMatriculados;
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        openModal.addEventListener('click', async () => {
            try {
                ...
                const respuesta = await fetch('components/cardContadores/actualizarContadores.php');
                const datos = await respuesta.json();
                const generos = datos.generos; // <-- Cambia aquí
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        async function cargarBootcamps() {
            try {
                const respuesta = await fetch('components/cardContadores/actualizarContadores.php');
                const datos = await respuesta.json();
                const bootcamps = datos.bootcamps;
