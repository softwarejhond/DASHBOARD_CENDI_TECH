...
<script>
    $(document).ready(function() {
        var totalPeriodos = <?php echo count($periods); ?>;
        ...
        // Función para generar nombre de período por defecto
        function generateDefaultPeriodName() {
            var nextNumber = totalPeriodos + 1;
            var padded = String(nextNumber).padStart(3, '0');
            return 'PERIODO-' + padded;
        }
        ...
        $('#bootcamp_course_select_create').on('change', function() {
            ...
            if (fullname && $(this).val()) {
                ...
                if (groupCode) {
                    ...
                    // Generar nombre por defecto basado en la cantidad de períodos
                    var defaultName = generateDefaultPeriodName();
                    updatePeriodName(defaultName);
                    console.log("Nombre generado por defecto:", defaultName);
