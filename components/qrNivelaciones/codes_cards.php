                    ...
                    <div class="mb-3">
                        <select id="bootcamp" name="bootcamp" class="form-select course-select" required>
                            <?php foreach ($courses_data as $course): ?>
                                <?php if (in_array($course['categoryid'], [3, 7, 8, 9, 10, 11, 12])): ?>
...
<script>
    ...
    function updateTitleAndUrl() {
        ...
        if (courseName && fecha) {
            ...
            document.getElementById('url').value = `https://cenditech.com.co/asistenciaMasterClass.php?fecha=${fechaUrl}&curso=${bootcamp.value}`;
        } else {
